...
namespace DAL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="BAKICITAKİPSİSTEMİ")]
	public partial class BakiciDataClassesDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertBAKICI(BAKICI instance);
    partial void UpdateBAKICI(BAKICI instance);
    partial void DeleteBAKICI(BAKICI instance);
    ...
    partial void DeletePOZISYON(POZISYON instance);
		...
		public BakiciDataClassesDataContext() : 
				base(global::DAL.Properties.Settings.Default.BAKICITAKİPSİSTEMİConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public BakiciDataClassesDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public BakiciDataClassesDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public BakiciDataClassesDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public BakiciDataClassesDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<BAKICI> BAKICIs
		{
			get
			{
				return this.GetTable<BAKICI>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.BAKICI")]
	public partial class BAKICI : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnBakiciIDChanging(int value);
    partial void OnBakiciIDChanged();
    ...
    partial void OnIsDurumIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BakiciID", DbType="Int NOT NULL")]
		public int BakiciID
		{
			get
			{
				return this._BakiciID;
			}
			set
			{
				if ((this._BakiciID != value))
				{
					this.OnBakiciIDChanging(value);
					this.SendPropertyChanging();
					this._BakiciID = value;
					this.SendPropertyChanged("BakiciID");
					this.OnBakiciIDChanged();
				}
			}
		}
    ...
    partial void OnDepartmanIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PozisyonAd", DbType="NVarChar(50)")]
